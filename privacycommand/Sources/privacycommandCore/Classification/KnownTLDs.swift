...
/// Canonical list of IANA top-level domains, used to tell a real hostname
/// apart from a compiled fragment that merely *looks* domain-shaped (a cert
/// field like `subject.ou`, a file name like `config.plist`, a bundle ID like
/// `com.apple.security.device.usb`). See `DomainValidator`.
///
/// Only the ASCII-alpha TLDs are kept — the binary-string domain regex can't
/// emit the `xn--` punycode TLDs anyway (its TLD class is `[a-z]{2,}`), so
/// they'd be dead weight.
///
/// Source: IANA root zone database
/// (https://data.iana.org/TLD/tlds-alpha-by-domain.txt)
/// Snapshot: Version 2026061900, Last Updated Fri Jun 19 07:07:01 2026 UTC
/// Regenerate by re-fetching that file, lowercasing, and keeping alpha-only
/// entries of length >= 2. 1286 entries.
enum KnownTLDs {
    ...
    "xerox", "xihuan", "xin", "xxx", "xyz", "yachts", "yahoo", "yamaxun", "yandex", "ye",
