...
public enum SDKFingerprintDatabase {
    ...
    // MARK: - Extended coverage (audit Wave 8) ---------------------------
    //
    // Additional widely-used SDKs the database was missing. Matching is anchored
    // (exact framework name / dotted-prefix bundle ID / host-boundary domain),
    // so a slightly-off fingerprint simply misses rather than false-positives.
    public static let extendedCoverage: [SDKFingerprint] = [
        .init(id: "mparticle", displayName: "mParticle", vendor: "mParticle, Inc.", category: .analytics,
              description: "Customer-data platform; fans events out to many downstream destinations.",
              frameworkPatterns: ["mParticle_Apple_SDK"], bundleIDPatterns: ["com.mparticle"], urlPatterns: ["mparticle.com"]),
        .init(id: "pendo", displayName: "Pendo", vendor: "Pendo.io", category: .analytics,
              description: "Product analytics and in-app guidance.",
              frameworkPatterns: ["Pendo"], bundleIDPatterns: ["com.pendo"], urlPatterns: ["pendo.io"]),
        .init(id: "fullstory", displayName: "FullStory", vendor: "FullStory, Inc.", category: .analytics,
              description: "Session replay and product analytics.",
              frameworkPatterns: ["FullStory"], bundleIDPatterns: ["com.fullstory"], urlPatterns: ["fullstory.com"]),
        .init(id: "smartlook", displayName: "Smartlook", vendor: "Smartlook.com", category: .analytics,
              description: "Session recording and analytics.",
              frameworkPatterns: ["SmartlookAnalytics", "Smartlook"], bundleIDPatterns: ["com.smartlook"], urlPatterns: ["smartlook.com"]),
        .init(id: "tenjin", displayName: "Tenjin", vendor: "Tenjin Inc.", category: .attribution,
              description: "Mobile-marketing attribution and analytics.",
              frameworkPatterns: ["TenjinSDK"], bundleIDPatterns: ["com.tenjin"], urlPatterns: ["tenjin.io", "track.tenjin.com"]),
        .init(id: "vungle", displayName: "Vungle (Liftoff)", vendor: "Liftoff Mobile", category: .advertising,
              description: "In-app video advertising and monetization.",
              frameworkPatterns: ["VungleSDK", "VungleAdsSDK"], bundleIDPatterns: ["com.vungle"], urlPatterns: ["vungle.com"]),
        .init(id: "chartboost", displayName: "Chartboost", vendor: "Chartboost, Inc.", category: .advertising,
              description: "Mobile-games advertising and monetization.",
              frameworkPatterns: ["ChartboostSDK", "Chartboost"], bundleIDPatterns: ["com.chartboost"], urlPatterns: ["chartboost.com"]),
        .init(id: "inmobi", displayName: "InMobi", vendor: "InMobi", category: .advertising,
              description: "Mobile advertising and audience platform.",
              frameworkPatterns: ["InMobiSDK"], bundleIDPatterns: ["com.inmobi"], urlPatterns: ["inmobi.com"]),
        .init(id: "mintegral", displayName: "Mintegral", vendor: "Mobvista", category: .advertising,
              description: "Programmatic advertising and monetization.",
              frameworkPatterns: ["MTGSDK"], bundleIDPatterns: ["com.mintegral", "com.mobvista"], urlPatterns: ["mintegral.com"]),
        .init(id: "adcolony", displayName: "AdColony", vendor: "AdColony (DigitalTurbine)", category: .advertising,
              description: "In-app video advertising.",
              frameworkPatterns: ["AdColony"], bundleIDPatterns: ["com.adcolony"], urlPatterns: ["adcolony.com"]),
        .init(id: "tapjoy", displayName: "Tapjoy", vendor: "Tapjoy (DigitalTurbine)", category: .advertising,
              description: "Rewarded advertising and offerwall.",
              frameworkPatterns: ["Tapjoy"], bundleIDPatterns: ["com.tapjoy"], urlPatterns: ["tapjoy.com"]),
        .init(id: "pangle", displayName: "Pangle", vendor: "ByteDance", category: .advertising,
              description: "ByteDance/TikTok advertising network.",
              frameworkPatterns: ["PAGAdSDK", "BUAdSDK"], bundleIDPatterns: ["com.pangle", "com.bytedance.Ads"], urlPatterns: ["pangle.io"]),
        .init(id: "clevertap", displayName: "CleverTap", vendor: "CleverTap, Inc.", category: .pushNotifications,
              description: "Customer engagement, analytics, and push messaging.",
              frameworkPatterns: ["CleverTapSDK"], bundleIDPatterns: ["com.clevertap"], urlPatterns: ["clevertap.com"]),
        .init(id: "customerio", displayName: "Customer.io", vendor: "Customer.io", category: .pushNotifications,
              description: "Customer messaging, push, and behavioural tracking.",
              frameworkPatterns: ["CustomerIO", "CustomerIOTracking", "CustomerIOMessagingPush"], bundleIDPatterns: ["io.customer"], urlPatterns: ["customer.io"]),
        .init(id: "moengage", displayName: "MoEngage", vendor: "MoEngage Inc.", category: .pushNotifications,
              description: "Customer engagement and analytics.",
              frameworkPatterns: ["MoEngageSDK", "MoEngage"], bundleIDPatterns: ["com.moengage"], urlPatterns: ["moengage.com"]),
        .init(id: "leanplum", displayName: "Leanplum", vendor: "Leanplum (CleverTap)", category: .pushNotifications,
              description: "Mobile engagement, messaging, and A/B testing.",
              frameworkPatterns: ["Leanplum"], bundleIDPatterns: ["com.leanplum"], urlPatterns: ["leanplum.com"]),
        .init(id: "pushwoosh", displayName: "Pushwoosh", vendor: "Pushwoosh Inc.", category: .pushNotifications,
              description: "Push notifications and customer engagement.",
              frameworkPatterns: ["PushwooshFramework", "Pushwoosh"], bundleIDPatterns: ["com.pushwoosh"], urlPatterns: ["pushwoosh.com"]),
        .init(id: "batch", displayName: "Batch", vendor: "Batch.com", category: .pushNotifications,
              description: "Push notifications and customer engagement.",
              frameworkPatterns: ["Batch"], bundleIDPatterns: ["com.batch"], urlPatterns: ["batch.com"]),
        .init(id: "embrace", displayName: "Embrace", vendor: "Embrace.io", category: .crashReporting,
              description: "Mobile observability: crashes, performance, and session insights.",
              frameworkPatterns: ["EmbraceIO", "Embrace"], bundleIDPatterns: ["io.embrace", "com.embrace"], urlPatterns: ["embrace.io"]),
        .init(id: "superwall", displayName: "Superwall", vendor: "Superwall, Inc.", category: .monetization,
              description: "Paywall and subscription-conversion platform.",
              frameworkPatterns: ["SuperwallKit"], bundleIDPatterns: ["com.superwall"], urlPatterns: ["superwall.com", "superwall.me"]),
        .init(id: "adapty", displayName: "Adapty", vendor: "Adapty Tech", category: .monetization,
              description: "In-app subscription management and paywall analytics.",
              frameworkPatterns: ["Adapty"], bundleIDPatterns: ["com.adapty"], urlPatterns: ["adapty.io"]),
        .init(id: "qonversion", displayName: "Qonversion", vendor: "Qonversion", category: .monetization,
              description: "Subscription management and revenue analytics.",
              frameworkPatterns: ["Qonversion"], bundleIDPatterns: ["com.qonversion"], urlPatterns: ["qonversion.io"]),
        .init(id: "purchasely", displayName: "Purchasely", vendor: "Purchasely", category: .monetization,
              description: "Paywall and subscription management.",
              frameworkPatterns: ["Purchasely"], bundleIDPatterns: ["io.purchasely", "com.purchasely"], urlPatterns: ["purchasely.com"]),
        .init(id: "glassfy", displayName: "Glassfy", vendor: "Glassfy", category: .monetization,
              description: "In-app subscription infrastructure.",
              frameworkPatterns: ["Glassfy"], bundleIDPatterns: ["io.glassfy", "com.glassfy"], urlPatterns: ["glassfy.io"]),
    ]
    ...
    public static let performance: [SDKFingerprint] = [
        .init(id: "datadog-rum", displayName: "Datadog RUM", vendor: "Datadog",
              ...
              frameworkPatterns: ["Datadog", "DatadogRUM", "DatadogCore", "DatadogLogs", "DatadogTrace", "DatadogInternal"],
    ...
    public static let monetization: [SDKFingerprint] = [
        .init(id: "revenuecat", displayName: "RevenueCat", vendor: "RevenueCat, Inc.",
              ...
              frameworkPatterns: ["RevenueCat", "PurchasesHybridCommon"],
        ...
        .init(id: "stripe", displayName: "Stripe", vendor: "Stripe, Inc.",
              ...
              frameworkPatterns: ["Stripe", "StripePaymentSheet", "StripePayments", "StripeCore", "StripeApplePay"],
    ...
    public static let push: [SDKFingerprint] = [
        ...
        .init(id: "onesignal", displayName: "OneSignal", vendor: "OneSignal",
              ...
              frameworkPatterns: ["OneSignal", "OneSignalFramework", "OneSignalCore", "OneSignalUser", "OneSignalNotifications", "OneSignalExtension"],
